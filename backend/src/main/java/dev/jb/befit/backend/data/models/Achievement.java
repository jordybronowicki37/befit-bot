...
public enum Achievement {
    ...
    LETS_GO_PLACES(AchievementDifficulty.HARD, "icon-achievement-13.png", "ach_lets_go_places", "Let's go places", "Reach a distance of 20km."),
    ...
    HEALTHY(AchievementDifficulty.EASY, "icon-achievement-17.png", "ach_healthy", "Let's get healthy", "Create your first log."),
