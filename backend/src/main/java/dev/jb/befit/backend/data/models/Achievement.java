...
public enum Achievement {
    ...
    KEEP_ON_STACKING(AchievementDifficulty.MEDIUM, "icon-09.png", "ach_keep_on_stacking", "Keep on stacking", "Have 5 concurrent logs of a single exercise that keep increasing your PR."),
    ...
    GOAL_REACHED(AchievementDifficulty.EASY, "icon-12.png", "ach_goal_reached", "Goal reached", "Complete a goal."),
    ...
    HEALTHY(AchievementDifficulty.EASY, "icon-17.png", "ach_healthy", "Healthy", "Create your first log"),
